 ...
 * 0xff123456 to a function expecting a SPColor, and it will automatically become a SPColor "object".
 * Similarly, SPColors may be treated as Ints.
 *
 * Note that when using properties of a SPColor other than ARGB, the values are ultimately stored as
 ...
 */
abstract SPColor(Int) from Int from UInt to Int to UInt
{
	public static inline var TRANSPARENT:SPColor = 0x00000000;
	public static inline var WHITE:SPColor = 0xFFFFFFFF;
	public static inline var GRAY:SPColor = 0xFF808080;
	public static inline var BLACK:SPColor = 0xFF000000;

	public static inline var GREEN:SPColor = 0xFF008000;
	public static inline var LIME:SPColor = 0xFF00FF00;
	public static inline var YELLOW:SPColor = 0xFFFFFF00;
	public static inline var ORANGE:SPColor = 0xFFFFA500;
	public static inline var RED:SPColor = 0xFFFF0000;
	public static inline var PURPLE:SPColor = 0xFF800080;
	public static inline var BLUE:SPColor = 0xFF0000FF;
	public static inline var BROWN:SPColor = 0xFF8B4513;
	public static inline var PINK:SPColor = 0xFFFFC0CB;
	public static inline var MAGENTA:SPColor = 0xFFFF00FF;
	public static inline var CYAN:SPColor = 0xFF00FFFF;

	/**
	 * A `Map<String, Int>` whose values are the static colors of `Color`.
	 * You can add more colors for `SPColor.fromString(String)` if you need.
	 */
	public static var colorLookup(default, null):Map<String, Int> = SPMacroUtil.buildMap("simple.SPColor");
	 ...
	 */
	public static inline function fromInt(Value:Int):SPColor
	{
		return new SPColor(Value);
	}
	 ...
	 * @return The color as a SPColor
	 */
	public static inline function fromRGB(Red:Int, Green:Int, Blue:Int, Alpha:Int = 255):SPColor
	{
		var color = new SPColor();
	 ...
	 * @return The color as a SPColor
	 */
	public static inline function fromRGBFloat(Red:Float, Green:Float, Blue:Float, Alpha:Float = 1):SPColor
	{
		var color = new SPColor();
	 ...
	 * @return The color as a SPColor
	 */
	public static inline function fromCMYK(Cyan:Float, Magenta:Float, Yellow:Float, Black:Float, Alpha:Float = 1):SPColor
	{
		var color = new SPColor();
	 ...
	 * @return	The color as a SPColor
	 */
	public static inline function fromHSL(Hue:Float, Saturation:Float, Lightness:Float, Alpha:Float = 1):SPColor
	{
		var color = new SPColor();
	...
	/**
	 * Parses a `String` and returns a `SPColor` or `null` if the `String` couldn't be parsed.
	 *
	 ...
	 * @return	A `SPColor` or `null` if the `String` couldn't be parsed
	 */
	public static function fromString(str:String):Null<SPColor>
	{
		var result:Null<SPColor> = null;
		str = StringTools.trim(str);

		if (COLOR_REGEX.match(str))
		{
			var hexColor:String = "0x" + COLOR_REGEX.matched(2);
			result = new SPColor(Std.parseInt(hexColor));
		...
		else
		{
			...
			for (key in colorLookup.keys())
			{
				...
				{
					result = new SPColor(colorLookup.get(key));
					break;
				}
			}
		}
	 ...
	 */
	public static function getHSBColorWheel(Alpha:Int = 255):Array<SPColor>
	{
	 ...
	 */
	public static inline function interpolate(Color1:SPColor, Color2:SPColor, Factor:Float = 0.5):SPColor
	{
	 ...
	 */
	public static function gradient(Color1:SPColor, Color2:SPColor, Steps:Int, ?Ease:Float->Float):Array<SPColor>
	{
		var output = new Array<SPColor>();
	 ...
	 */
	@:op(A * B)
	public static inline function multiply(lhs:SPColor, rhs:SPColor):SPColor
	{
		return SPColor.fromRGBFloat(lhs.redFloat * rhs.redFloat, lhs.greenFloat * rhs.greenFloat, lhs.blueFloat * rhs.blueFloat);
	}
	 ...
	 */
	@:op(A + B)
	public static inline function add(lhs:SPColor, rhs:SPColor):SPColor
	{
		return SPColor.fromRGB(lhs.red + rhs.red, lhs.green + rhs.green, lhs.blue + rhs.blue);
	}

	/**
	 * Subtract the RGB channels of one SPColor from another
	 */
	@:op(A - B)
	public static inline function subtract(lhs:SPColor, rhs:SPColor):SPColor
	{
		return SPColor.fromRGB(lhs.red - rhs.red, lhs.green - rhs.green, lhs.blue - rhs.blue);
	}

	/**
	 * Returns a Complementary SPColor Harmony of this color.
	 * A complementary hue is one directly opposite the color given on the color wheel
	 *
	 * @return	The complimentary color
	 */
	public inline function getComplementHarmony():SPColor
	{
		return fromHSB(MathUtil.wrap(Std.int(hue) + 180, 0, 350), brightness, saturation, alphaFloat);
	}

	/**
	 * Returns an Analogous SPColor Harmony for the given color.
	...
	/**
	 * Returns an Split Complement SPColor Harmony for this color.
	...
	public inline function getSplitComplementHarmony(Threshold:Int = 30):Harmony
	{
		...
		var warmer:SPColor = fromHSB(MathUtil.wrap(oppositeHue - Threshold, 0, 350), saturation, brightness, alphaFloat);
		var colder:SPColor = fromHSB(MathUtil.wrap(oppositeHue + Threshold, 0, 350), saturation, brightness, alphaFloat);

		return {original: this, warmer: warmer, colder: colder};
	}

	/**
	 * Returns a Triadic SPColor Harmony for this color. A Triadic harmony are 3 hues equidistant
	...
	{
		var triadic1:SPColor = fromHSB(MathUtil.wrap(Std.int(hue) + 120, 0, 359), saturation, brightness, alphaFloat);
		var triadic2:SPColor = fromHSB(MathUtil.wrap(Std.int(triadic1.hue) + 120, 0, 359), saturation, brightness, alphaFloat);
	 ...
	 */
	public inline function to24Bit():SPColor
	{
	 ...
	 */
	public function getDarkened(Factor:Float = 0.2):SPColor
	{
		Factor = MathUtil.bound(Factor, 0, 1);
		var output:SPColor = this;
	 ...
	 */
	public inline function getLightened(Factor:Float = 0.2):SPColor
	{
		Factor = MathUtil.bound(Factor, 0, 1);
		var output:SPColor = this;
	 ...
	 */
	public inline function getInverted():SPColor
	{
		var oldAlpha = alpha;
		var output:SPColor = SPColor.WHITE - this;
	 ...
	 * @return This color
	 */
	public inline function setRGB(Red:Int, Green:Int, Blue:Int, Alpha:Int = 255):SPColor
	{
		red = Red;
		green = Green;
		blue = Blue;
	 ...
	 * @return This color
	 */
	public inline function setRGBFloat(Red:Float, Green:Float, Blue:Float, Alpha:Float = 1):SPColor
	{
		redFloat = Red;
		greenFloat = Green;
		blueFloat = Blue;
	 ...
	 * @return This color
	 */
	public inline function setCMYK(Cyan:Float, Magenta:Float, Yellow:Float, Black:Float, Alpha:Float = 1):SPColor
	{
	 ...
	 * @return	This color
	 */
	public inline function setHSB(Hue:Float, Saturation:Float, Brightness:Float, Alpha:Float):SPColor
	{
	 ...
	 * @return	This color
	 */
	public inline function setHSL(Hue:Float, Saturation:Float, Lightness:Float, Alpha:Float):SPColor
	{
	 ...
	 */
	inline function setHSChromaMatch(Hue:Float, Saturation:Float, Chroma:Float, Match:Float, Alpha:Float):SPColor
	{
		Hue %= 360;
		var hueD = Hue / 60;
